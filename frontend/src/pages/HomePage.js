          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-12">
              <div className="text-center p-4 sm:p-6 lg:p-8">
                ...
                <p className="text-sm sm:text-base text-gray-600 leading-relaxed">Free shipping on orders over ₹{websiteSettings?.features?.freeShippingThreshold || 2000}. Fast and reliable delivery to your doorstep across India.</p>
              </div>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="relative">
              ...
              <div className="text-center mt-4 sm:hidden">
                <p className="text-xs text-gray-500">← Scroll to see more categories →</p>
              </div>
            </div>
